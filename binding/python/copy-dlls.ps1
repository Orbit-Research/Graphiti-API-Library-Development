# Delete ccurrent graphiti lib files
Write-Error "Deleting libGraphiti_C.dll, libGraphiti.dll"
rm libGraphiti_C.dll, libGraphiti.dll -ErrorAction SilentlyContinue
